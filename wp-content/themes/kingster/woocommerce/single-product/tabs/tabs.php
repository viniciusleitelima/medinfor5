...
if( class_exists('gdlr_core_pb_element_tab') ){
	...
	if( !empty($tabs) ){
		echo '<div class="kingster-woocommerce-tab gdlr-core-tab-item gdlr-core-js gdlr-core-tab-style2-horizontal gdlr-core-center-align" >';
		
		$count = 0; $active = 1;
		echo '<div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font" >';
		foreach( $tabs as $key => $tab ){ $count++;
			echo '<div class="gdlr-core-tab-item-title kingster-title-font ' . ($count == $active? ' gdlr-core-active': '') . '" data-tab-id="' . esc_attr($count) . '" >';
