	...
	public function render_news_page() {
		...
		$plugins = array(
			...
			array(
				...
				"url" => "https://wordpress.org/plugins/post-snippets/"
			)
		);
	...
	public function render_pro_page() {
        ...
        <div class="wrap about-wrap simple-author-box-wrap">
            ...
            <h2 class="nav-tab-wrapper wp-clearfix">
                <a href="<?php echo admin_url( 'admin.php?page=simple-author-box-options-pricing' ); ?>"
                ...
                <table class="free-pro-table">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-right">
                            <a href="?page=simple-author-box-options-pricing"
