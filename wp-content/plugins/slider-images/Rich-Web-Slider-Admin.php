			...
			<table class='rich_web_SaveSl_Table' style='float:left;'>
				...
				<tr>
					<td style='width:100%' colspan='2'>
						<div id="" class="">
							<a href="#" class="button videoButton" style="border:1px solid rgba(0, 73, 107, 0.8); color:rgba(0, 73, 107, 0.8); background-color:#f4f4f4"  title="Add Image" id="rich_webVideoSrc" onclick="rich_web_Video_Src_Clicked()">
								<span class=""></span>Add Video
								<span style="font-weight: 900; color: #ff0000; font-size: 14px; cursor: default;position: absolute;left: 110%;">(Pro)</span>
							</a>
						</div>
					</td>
				</tr>
				<tr>
					<td colspan='2'>
						<input type="text" id="rich_web_videoSrc_2" class="JSlInputVideo rich_web_ImgSrc_Select" readonly>
					</td>
				</tr>
				<tr>
					<td style='width:100%' colspan='2'>
