	...
	class Rich_Web_Photo_Slider extends WP_Widget
	{
		...
		function widget($args,$instance)
		{
			...
			if($Rich_Web_Slider_Effects[0]->slider_type=='Slider Navigation')
			{
				...
				print_r(empty($Rich_Web_Slider_Effect_Loader));
			}
			...
			<?php }else if($Rich_Web_Slider_Effects[0]->slider_type=='Thumbnails Slider & Lightbox'){ ?>
				...
				<?php } ?>
					...
					.anythingSlider<?php echo $Rich_Web_Slider_Manager[0]->id; ?> .anythingBase { background: transparent; list-style: none; position: absolute; overflow: visible !important; top: 0; left: 0; margin: 0; padding: 0 !important; }
					...
					#RichWeb_TSL_slider<?php echo $Rich_Web_Slider_Manager[0]->id; ?> { list-style: none; }
			...
			<?php } ?>
				<ul id="RichWeb_TSL_slider<?php echo $Rich_Web_Slider_Manager[0]->id;?>" style='opacity:1;display:none;'>
					<?php for($i=0;$i<count($Rich_Web_Slider_Images);$i++){ 
					 ...
					 ?>
						<li style='padding:0px;background:none;'  onclick="creatPopup('<?php echo $Rich_Web_Slider_Videos[$i]->Sl_Video_Url; ?>',<?php echo $i; ?>)">
							<?php if($Rich_Web_Slider_Videos[$i]->Sl_Video_Url !== '' && $Rich_Web_Slider_Videos[$i]->Sl_Video_Url !== null && $Rich_Web_Slider_Videos[$i]->Sl_Video_Url !== "undefined") { ?>
				...
				<script type="text/javascript">
					...
					var images = document.querySelectorAll(".contImgWidth<?php echo $Rich_Web_Slider_Manager[0]->id;?>");
					var videos = [];
					var titeles = [];
					for(var i = 0; i < images.length; i++){
						videos[i] = images[i].dataset.video;
						titeles[i] = images[i].getAttribute('title');
					}
					var count = 0;
					
					function creatPopup(vSrc,n){
						count = n;
						var thumbOverlay = document.createElement("div");
						thumbOverlay.setAttribute("class","thumbOverlay<?php echo $Rich_Web_Slider_Manager[0]->id;?>");
						document.body.appendChild(thumbOverlay);
						var thumbContent = document.createElement("div");
						thumbContent.setAttribute("class","thumbContent<?php echo $Rich_Web_Slider_Manager[0]->id;?>");
						document.body.appendChild(thumbContent);
						var thumbContentImg = document.createElement("img");
						thumbContentImg.setAttribute("class","thumbContentImg<?php echo $Rich_Web_Slider_Manager[0]->id;?>");
						thumbContentImg.setAttribute("src",images[count].getAttribute("src"));
						thumbContentImg.setAttribute("onclick","plVideo('"+vSrc+"')");
						thumbContent.appendChild(thumbContentImg);
						...
						thumbContent.appendChild(thumbContentvIc);
						if(!vSrc) {
						...
						thumbContent.appendChild(thumbContentVideo);
						...
						position(thumbContent,slOptions);
						...
						prev.setAttribute("onclick","prevThumb()");
						...
						next.setAttribute("onclick","nextThumb()");
						slOptions.appendChild(next);
						var span = document.createElement("span");
						var counter = document.createTextNode((count+1) + " of " + images.length);
						...
						var text = document.createTextNode(titeles[count]);
					...
					function changeSlider(){
						...
						document.querySelector(".thumbContentImg<?php echo $Rich_Web_Slider_Manager[0]->id;?>").setAttribute("src",images[count].getAttribute("src"));
						document.querySelector(".thumbContentImg<?php echo $Rich_Web_Slider_Manager[0]->id;?>").setAttribute("onclick","plVideo('"+videos[count]+"')");
						document.querySelector(".vIcContentPopup").setAttribute("onclick","plVideo('"+videos[count]+"')");
						document.querySelector(".thumbHeader<?php echo $Rich_Web_Slider_Manager[0]->id;?>").innerText = titeles[count];
						document.querySelector(".counter<?php echo $Rich_Web_Slider_Manager[0]->id;?>").innerText = (count+1) + " of " + images.length;
						videos[count] ? document.querySelector(".vIcContentPopup").style.display = 'inline' : document.querySelector(".vIcContentPopup").style.display = 'none'; 
