...
<style type='text/css'>
	...
	.JAddSlider2 { position: absolute; right: 10px; bottom: 10px; padding: 5px 10px; background: #47bde5; cursor: pointer; border: none; box-shadow: 0px 0px 2px #47bde5; color: #fff; text-shadow:1px 1px 1px #000000; height:30px; transition:all 0.3s linear; }
